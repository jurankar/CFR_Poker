...
#CONSTANTS
COMPUTED_NODE_REGRET_REQUIREMENT = 1500      # to je meja regreta (max value v arrayu node.regretSum), ki sem jo določil da je node izracunan --> kasneje, ko ga boš zares učil to povečaj
